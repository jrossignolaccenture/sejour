...
//        demandeService.createApplication(TypeDemande.premiere, NatureDemande.sejour_etudiant);
...
//        		Demande demande = demandeMapper.demandeDTOToDemande(demandeDTO);
//                demande.setStatut(StatutDemande.paid);
//                demande.setModificationDate(DateTime.now());
...
//        Demande demande = demandeService.getCurrentDemande(StatutDemande.paid);
