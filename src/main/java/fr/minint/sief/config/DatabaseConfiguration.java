...
//    }
    ...
    public String initDB() throws Exception {
		...
		db.getCollection("JHI_USER").insertOne(Document.parse("{_id : 'user-bak', _class : 'fr.minint.sief.domain.User', password : '$2a$10$m0bMJ9o3tPNNA4ey5VH4oOwee6Oc63uicBtbwRTScZ8hVu5urLt6.',"
		...
		db.getCollection("JHI_USER").insertOne(Document.parse("{_id : 'user-martin', _class : 'fr.minint.sief.domain.User', password : '$2a$10$H.A4uJkZR9viLrv7RfS.0O/CsSrfv9bRp6eVDuFMzmwfLZpE0D2O6',"
		...
		db.getCollection("JHI_USER").insertOne(Document.parse("{_id : 'user-petit', _class : 'fr.minint.sief.domain.User', password : '$2a$10$1/9ZXHiPPSJmM16lMKZffedS0/fEJzzE6U39.uC0m8wL.k8YeOE7a',"
		...
		db.getCollection("JHI_USER").insertOne(Document.parse("{_id : 'user-dupuis', _class : 'fr.minint.sief.domain.User', password : '$2a$10$DGJ8ZMqNTb3dlnrfq4wCjOKU8rMa2iCe2pgIinkOlYWDu/ygGETD6',"
		...
		db.getCollection("JHI_USER").insertOne(Document.parse("{_id : ObjectId('56026f5fd4c6d4a17b866d88'), _class : 'fr.minint.sief.domain.User', password : '$2a$10$zIrzNzyxPJFiMEQFUUGDcepj/qDuKUYGf0oMjz/W/UILGHxnu5sw6',"
				...
				+ "'address' : { 'number' : '11', 'street' : 'rue barbet', 'complement' : '', 'postal_code' : '75007', 'city' : 'Paris', 'country' : 'FR', 'phone' : '+82 51 999999', 'email' : 'kim.soon.jeen@gmail.com', 'contact_type' : [ 'email' ], 'admissible' : true, 'validate_on' : ISODate('2015-11-23T16:39:26.590Z') }, "
				+ "project: {},"
