...
class ProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Project entity")
        ...
        .repeat(2) {
            ...
            .post("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "comingDate":"2020-01-01T00:00:00.000Z", "university":"SAMPLE_TEXT", "training":"SAMPLE_TEXT", "trainingStart":"2020-01-01T00:00:00.000Z", "trainingLength":"0", "resourceType":null, "resourceAmount":"0", "resourceProof":"SAMPLE_TEXT", "inscriptionCertificate":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
